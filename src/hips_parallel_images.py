...
def find_fits_images(
    ...
    if band_patterns is None:
        ...
        band_patterns = {
            "g": r".*[_-]g[_-].*\.fits?$|.*[_-]g\.fits?$|.*_g_band.*\.fits?$",
            "r": r".*[_-]r[_-].*\.fits?$|.*[_-]r\.fits?$|.*_r_band.*\.fits?$",
            "i": r".*[_-]i[_-].*\.fits?$|.*[_-]i\.fits?$|.*_i_band.*\.fits?$",
        }
    ...
    for band, color in band_to_color.items():
        ...
        for fits_file in images:
            ...
            if not args.dry_run:
                ...
                print(f"    [DRY RUN] Submeteria job para {image_id}")
